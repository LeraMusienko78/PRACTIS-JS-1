...
while (group.length > i) {
    app === null || app === void 0 ? void 0 : app.innerHTML += `
       <h1>${group[i]}</h1>
    `;
    i++;
}
...
for (let j = 0; j < group2.length; j++) {
    live === null || live === void 0 ? void 0 : live.innerHTML += `
    <h1>${group2[j]}</h1>
    `;
}
for (let i = 0; i < 10; i++) {
    if (i % 2 === 0) {
        ...
        app === null || app === void 0 ? void 0 : app.append(red);
    }
    else {
        ...
        app === null || app === void 0 ? void 0 : app.append(blue);
    }
}
